...
{
	/// <summary>
	/// This class is an input module that only accepts keyboard input. Props to recon472 on StackOverflow for
	/// this script. http://answers.unity3d.com/questions/782423/unity-46-ui-restrict-eventsystem-only-to-keyboard.html
	/// </summary>
